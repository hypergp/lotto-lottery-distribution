...
if(isset($_POST['submit'])){
  ...
  $status = $_POST['status'];
   ...
   $sql = " UPDATE `logina` SET `name`='$name',`email`='$email',`phone`='$phone_no',`password`='$password',`dob`='$dob' WHERE `id` = '$id' " ;
...
<div class="container-fluid">
    ...
    ?>
                ...
                <!--<label for="user_type_id">Status: </label>
					...
					<select name="user_type" disabled class="form-control" id="user_type_id">
