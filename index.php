		...
		<div class="container-fluid px-lg-4">
			<nav class="py-4">
                        <div class="logo" id="logo">
                            <a href="index.html">LOTTERY MANAGEMENT SYSTEM</a>
                            
                        </div>
                        <label for="drop" class="toggle">Menu</label>
                        <input type="checkbox" id="drop">
                        <ul class="menu mt-md-3">
							<li style="color:white;" class="mr-lg-2"><a style="color:white;" href="retailerreg.php" class="scroll">Registration</a></li>
                            <li style="color:white;" class="mr-lg-2"><a style="color:white;" href="login (1).php" class="scroll">Login</a></li>
							<li style="color:white;" class="mr-lg-2"><a style="color:white;" href="feedback.php" class="scroll">Feedback</a></li>
                        </ul>
                    </nav>
		</div>
	</header>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="style-banner">
					<h1 class="text-white">LOTTERY MANAGEMENT</h1>
					<p class="mt-5 text-white">Advanced Lottery Management System for Retailers </p>
